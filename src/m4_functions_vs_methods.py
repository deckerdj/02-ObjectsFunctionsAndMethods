...
Authors: David Mutchler, Dave Fisher, Vibha Alangar, Amanda Stouder,
         their colleagues and Vibha Algyr and Daniel Decker.
"""  # DONE 1
...
def try_methods_and_functions():
    ...
    jack.backward(150)
    jack.speed = 1
    draw_many_squares(jack, 2, 100, 30)
    jack.speed = 5
    jack.pen = rg.Pen('red', 5)
    draw_many_squares(jack, 10, 50, 15)
    jack.speed = 100
    jack.pen = rg.Pen('red', 35)
    draw_many_squares(jack, 8, 300, 60)
    jack.pen = rg.Pen('black', 3)
    jack.backward(200)
    jack.draw_circle(30)
    jack.draw_square(50)
